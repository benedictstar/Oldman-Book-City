...
<div style="margin:50px;display: flex;flex-direction: row;align-items:center;margin-bottom: 25px">
    ...
    <div class="container">
        <form action="/log?type=2" method="post" class="parent">
            <input type="text" name="tel" placeholder="输入用户手机号获取该用户购买日志" autocomplete="off">
...
<c:if test="${empty requestScope.totalBuyHistory || requestScope.totalBuyHistory.buyHistories.size()==0}">
